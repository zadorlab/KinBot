...
class IRC:
    ...
    def __init__(self,rxn):
        self.rxn = rxn #instance of the reac_family object the family this reaction belongs to
    ...
    def irc2stationary_pt(self):
        ...
        for i,direction in enumerate(directions):
            ...
            err, geom = self.rxn.qc.get_qc_geom(irc_name, self.rxn.species.natom, allow_error = 1)
            if err == -1:
                return 0
    ...
    def do_irc_calculations(self):
        ...
        instance_name = self.rxn.instance_name
        err, geom = self.rxn.qc.get_qc_geom(instance_name, self.rxn.species.natom)
        ...
        for i,direction in enumerate(directions):
            ...
            kwargs = self.rxn.qc.get_qc_arguments(irc_name, self.rxn.species.mult, irc = direction.lower())
