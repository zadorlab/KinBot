...
def do_12_shift_S_F(species, instance, step, instance_name):
    """
    ...
    step, fix, change, release = get_constraints_12_shift_S_F(step, species, instance,geom)
...
def get_constraints_12_shift_S_F(step,species,instance,geom):
    """
