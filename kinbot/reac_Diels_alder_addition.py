...
def do_Diels_alder_addition(species, instance, step, instance_name):
    """
    ...
    step, fix, change, release = get_constraints_Diels_alder_addition(step, species, instance,geom)
...
def get_constraints_Diels_alder_addition(step,species,instance,geom):
    """
    ...
    if step ==0 :
        ...
        constraint = [instance[4] + 1,instance[5] + 1,fval]
        change.append(constraint)
