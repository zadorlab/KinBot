...
def do_H2_Elimination(species, instance, step, instance_name):
    """
    ...
    step, fix, change, release = get_constraints_H2_Elimination(step, species, instance,geom)
...
def get_constraints_H2_Elimination(step,species,instance,geom):
    """
