...
def do_HO2_Elimination_from_PeroxyRadical(species, instance, step, instance_name):
    """
    ...
    step, fix, change, release = get_constraints_HO2_Elimination_from_PeroxyRadical(step, species, instance,geom)
...
def get_constraints_HO2_Elimination_from_PeroxyRadical(step,species,instance,geom):
    """
    ...
    if step < 12:
        ...
        fval = 2.0
        constraint = [instance[2] + 1,instance[3] + 1,fval]
        change.append(constraint)
