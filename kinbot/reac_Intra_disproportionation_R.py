...
def do_Intra_disproportionation_R(species, instance, step, instance_name):
    """
    ...
    step, fix, change, release = get_constraints_Intra_disproportionation_R(step, species, instance,geom)
...
def get_constraints_Intra_disproportionation_R(step,species,instance,geom):
    """
