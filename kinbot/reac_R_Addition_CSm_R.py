...
def do_R_Addition_CSm_R(species, instance, step, instance_name):
    """
    ...
    step, fix, change, release = get_constraints_R_Addition_CSm_R(step, species, instance,geom)
...
def get_constraints_R_Addition_CSm_R(step,species,instance,geom):
    """
