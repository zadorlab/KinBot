...
def do_Retro_Ene(species, instance, step, instance_name):
    """
    ...
    step, fix, change, release = get_constraints_Retro_Ene(step, species, instance,geom)
...
def get_constraints_Retro_Ene(step,species,instance,geom):
    """
    ...
    if step < 12:
        ...
        val = new_bond_length(species,instance[0],instance[-1],step - 11,10,final_dist[0],geom)
        ...
        val = new_bond_length(species,instance[2],instance[3],step - 11,10,final_dist[2],geom)
