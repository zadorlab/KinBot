...
def do_birad_recombination_F(species, instance, step, instance_name):
    """
    ...
    step, fix, change, release = get_constraints_birad_recombination_F(step, species, instance,geom)
...
def get_constraints_birad_recombination_F(step,species,instance,geom):
    """
