...
def do_intra_H_migration(species, instance, step, instance_name):
    """
    ...
    step, fix, change, release = get_constraints_intra_H_migration(step, species, instance,geom)
...
def get_constraints_intra_H_migration(step,species,instance,geom):
    """
