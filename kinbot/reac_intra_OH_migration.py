...
def do_intra_OH_migration(species, instance, step, instance_name):
    """
    ...
    #the constraints for this step
    step, fix, change, release = get_constraints_intra_OH_migration(step, species, instance,geom)
...
def get_constraints_intra_OH_migration(step,species,instance,geom):
    """
