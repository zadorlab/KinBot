...
def do_r13_insertion_ROR(species, instance, step, instance_name):
    """
    ...
    step, fix, change, release = get_constraints_r13_insertion_ROR(step, species, instance,geom)
...
def get_constraints_r13_insertion_ROR(step,species,instance,geom):
    """
