...
def do_r13_insertion_RSR(species, instance, step, instance_name):
    """
    ...
    step, fix, change, release = get_constraints_r13_insertion_RSR(step, species, instance,geom)
...
def get_constraints_r13_insertion_RSR(step,species,instance,geom):
    """
