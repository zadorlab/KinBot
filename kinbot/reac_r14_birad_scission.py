...
def do_r14_birad_scission(species, instance, step, instance_name):
    """
    ...
    step, fix, change, release = get_constraints_do_r14_birad_scission(step, species, instance,geom)
...
def get_constraints_do_r14_birad_scission(step,species,instance,geom):
    """
