...
def do_r14_cyclic_birad_scission_R(species, instance, step, instance_name):
    """
    ...
    step, fix, change, release = get_constraints_r14_cyclic_birad_scission_R(step, species, instance,geom)
...
def get_r14_cyclic_birad_scission_R(step,species,instance,geom):
    """
