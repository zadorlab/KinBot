...
def do_r22_cycloaddition(species, instance, step, instance_name):
    """
    ...
    step, fix, change, release = get_constraints_r22_cycloaddition(step, species, instance,geom)
...
def get_constraints_r22_cycloaddition(step,species,instance,geom):
    """
    ...
    if step == 0:
        ...
        constraint = [instance[0] + 1,instance[1] + 1, instance[2] + 1]
